...
hljs.registerLanguage("vbscript", function (e) {
    return {
        ...
        k: {
            ...
            literal: "true false null noflowers empty",
        },
        i: "//",
        c: [
            e.inherit(e.QSM, { c: [{ b: '""' }] }),
...
hljs.registerLanguage("kotlin", function (e) {
    ...
    return {
        k: {
            typename:
                "Byte Short Char Int Long Boolean Float Double Void Unit Noflowers",
            literal: "true false null",
            keyword: a,
        },
        c: [
